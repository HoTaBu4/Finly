...
- Красивий екран з переліком преміум фіч
- Акцент: "Захисти свої дані — синхронізуй між пристроями"
- Кнопка "Купити" → RevenueCat або Stripe Checkout
- Після оплати: `isPremium = true` зберігається локально і підтверджується сервером
