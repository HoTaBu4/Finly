const en = {
  ...
  auth: {
    ...
    signUp: {
      ...
      subtitle: 'Link your premium purchase and protect your Finzelo data.',
  ...
  resetPassword: {
    ...
    updateSubtitle: 'Choose a new password for your Finzelo account.',
    newPassword: 'New password',
    confirmPassword: 'Confirm password',
    confirmPasswordPlaceholder: 'Repeat password',
    sendLink: 'Send reset link',
    updatePassword: 'Update password',
    note: 'Open the reset link from this device so Finzelo can verify your recovery session.',
    invalidEmail: {
      title: 'Check email',
  ...
  authConfirm: {
    ...
    verifyingMessage: 'Finzelo is verifying your confirmation link.',
...
const pl: Translations = {
  ...
  auth: {
    ...
    signUp: {
      title: 'Utwórz konto',
      subtitle: 'Połącz zakup premium i zabezpiecz swoje dane Finzelo.',
  ...
  resetPassword: {
    ...
    updateSubtitle: 'Wybierz nowe hasło do konta Finzelo.',
    newPassword: 'Nowe hasło',
    confirmPassword: 'Potwierdź hasło',
    confirmPasswordPlaceholder: 'Powtórz hasło',
    sendLink: 'Wyślij link',
    updatePassword: 'Zmień hasło',
    note: 'Otwórz link resetujący na tym urządzeniu, aby Finzelo mogło zweryfikować sesję.',
    invalidEmail: {
      title: 'Sprawdź email',
  ...
  authConfirm: {
    ...
    verifyingMessage: 'Finzelo weryfikuje link potwierdzający.',
